...
public class ApprovedBookingFetcher {
    private static final String TAG = "BookingFetcher";
    private final FirebaseFirestore db;
    private final String doctorId;
    private final BookingFetchListener listener;

    public ApprovedBookingFetcher(String doctorId, BookingFetchListener listener) {
        this.db = FirebaseFirestore.getInstance();
        this.doctorId = doctorId;
        this.listener = listener;
    }

    // Existing method for pending bookings
    ...
    // New method for approved bookings
